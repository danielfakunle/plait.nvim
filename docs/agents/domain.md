...
When output names a domain concept, use the term as defined in `CONTEXT.md`. If the concept is not in the glossary, reconsider introducing a synonym or note the terminology gap for `/domain-modeling`.
