  ...
  fields = {
    ...
    mappings = {
      ...
      fields = {
        ...
        accept = { type = 'mapping', default = '<CR>' },
        select_and_accept = { type = 'mapping', default = '<C-y>' },
        previous_arrow = { type = 'mapping', default = '<Up>' },
        next_arrow = { type = 'mapping', default = '<Down>' },
        hide = { type = 'mapping', default = '<C-e>' },
